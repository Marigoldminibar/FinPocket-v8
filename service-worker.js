const CACHE='finpocket-v5';
const ASSETS=['./','./index.html','./style.css','./engine.js','./app.js','./storage.js','./notifications.js','./ui.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./qr.html'];
