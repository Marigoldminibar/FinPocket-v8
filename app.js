...
(async () => {
  ...
  // =========================================================
  // QR CİHAZ EŞLEŞTİRME — FIREBASE TEK KULLANIMLIK TOKEN
  // =========================================================
    ...
    document.body.innerHTML = `
      <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#0b1220;color:#fff;font-family:Arial;text-align:center;padding:30px;box-sizing:border-box">
        <div style="max-width:520px">
          ...
          <h2>${title}</h2>
          <p style="color:#cbd5e1;line-height:1.6">${text}</p>
        </div>
      </div>`;
  }
  ...
  if (mobileMode) {
    try {
      ...
      showPairError('Erişim doğrulanamadı', 'Firebase bağlantısı veya cihaz eşleştirmesi başarısız.');
      return;
    }
  }
